...
public class Ambassador {
  ...
  private void inject() throws ReflectiveOperationException {
    ...
    argumentRegistry.invoke(null,ArgumentIdentifier.id("forge:enum", mapSet(MINECRAFT_1_20_2, -255), mapSet(MINECRAFT_1_19, 50)), EnumArgumentProperty.class, EnumArgumentPropertySerializer.ENUM);
    argumentRegistry.invoke(null,ArgumentIdentifier.id("forge:modid", mapSet(MINECRAFT_1_20_2, -254), mapSet(MINECRAFT_1_19, 51)), ModIdArgumentProperty.class,
